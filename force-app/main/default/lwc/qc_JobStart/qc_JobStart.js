...
const FIELDS = [
    ...
    'Quality_Control__c.House_Unit__r.Is_house_ready_for_tile__c',
];


export default class QcJobStart extends LightningElement {
    @api recordId;
    @api objectApiName;
    ...
    handleLoad(event) {
        if (!this.initDone) {
            ...
            this.showmoreq = (this.qc.data.fields.Is_house_ready_for_tile__c.value === "No") ? true : false;
        }
    }
