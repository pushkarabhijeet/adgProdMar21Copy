...
export default class QcBuildSheet extends LightningElement {
      ...
      handleLoad(event) {
       ...
       // QC Handlers
        ...
        /// File upload - one handler for each image input so we can rename with a meaningful name...
            get acceptedFormats() {
                return ['.pdf', '.png','.jpg','.jpeg'];
            }

            handleUploadFinished_Build(event) {
                // Get the list of uploaded files
                console.log('---> start build sheet handleUploadFinished_Build');
                let prefix = 'Build_Measure_';
                let hiddenPicField = 'Picture_Build_Measure__c';
                ...
                console.log('---> hiddenPicField: ' + hiddenPicField );
